...
- [Script de Ingestão](ingestion/README.md)
- [Roteiro de Narração](ROTEIRO_NARACAO.md)
- [Script de Demo](DEMO_SCRIPT.md)
...
- ⚠️ As credenciais no `.env` são apenas para **desenvolvimento**
- Para **produção**, use secrets management (AWS Secrets, HashiCorp Vault, etc)
- A chave API é hardcoded no exemplo; implemente JWT em produção
- PostgreSQL exposto apenas localmente

---

## 📈 Performance

- **Ingestão**: 100 registros a cada 5 minutos
- **Dashboard**: Atualização em tempo real via REST
- **Banco de dados**: Índices em colunas principais
- **Containerização**: Otimizada para desenvolvimento local
...
- **GitHub Issues**: [Abrir uma issue](https://github.com/RafaApk/driva-pipline/issues)
- **Email**: rcruz@alunos.utfpr.edu.br
...
**Desenvolvido com ❤️ pela equipe DRIVA**
